...
let json = [
  {
    ...
    "challengeSteps": [
      ...
      },
      {
        ...
        "details": "Polkadot is super adaptable, so developers can make their own blockchains to fit their needs. That means you can use Polkadot for all kinds of different things - no more settling for pre-made blockchains! Plus, Polkadot lets you easily move assets between different blockchains, so the possibilities are endless!"
      },
      {
        "id": 7,
        "imageUrl": "https://i.imgur.com/kQKhtLG.png",
        "title": "The future of blockchain",
        "details": "Consider legacy blockchains to be small islands separated from one another. Each island has its own set of resources and restrictions, making communication difficult. That's similar to traditional blockchains! They're all separate from one another, with their own set of laws and constraints, making it difficult to share information or collaborate. Polkadot, on the other hand, functions as a bridge between these 'islands,' uniting them so they may work more efficiently and quickly."
      },
      {
        "id": 8,
        "choices": [
          "By allowing different parachains to collaborate and transfer data without much delay",
          "By using advanced encryption techniques",
          "By limiting the number of transactions that can be processed at once"
        ],
        "correctChoice": "By allowing different parachains to collaborate and transfer data without much delay",
        "title": "How does Polkadot improve blockchain transactions?"
      },
      {
        "id": 9,
        "choices": [
          "Improved speed and efficiency of blockchain transactions",
          "Customizable blockchains that allow developers to design specific functionalities for their chain",
          "Ability to connect different blockchains and transfer assets easily",
          "All of the above"
        ],
        "correctChoice": "All of the above",
        "title": "Which of these are the benefits of Polkadot?"
      },
      {
        "id": 10,
        "choices": [
      ...
      },
      {
        ...
        "title": "Kusama - Polkadot's wild cousin",
        "details": "When you're developing a website, you usually have three stages: development, staging, and production. But in the blockchain world, it's a bit different. There's usually just development and production - that is, until you meet Kusama! Kusama is like Polkadot's adventurous cousin. It lets developers try out their parachains under real world conditions in a “canary network” before they're released on the main Polkadot network."
      },
      {
        "id": 12,
        "imageUrl": "https://i.imgur.com/SHmsZPe.png",
        "title": "Canary network - explained!",
        "details": "A canary network is a live network that allows developers to test their blockchain under real-world conditions before launching it on the mainnet. It’s different from a testnet because it carries real value and transactions, providing a more authentic environment for testing. Think of Kusama like a fun and exciting adventure, where developers can take risks and test their limits. This helps create a stronger and more secure Polkadot ecosystem in the end!"
      },
      {
        "id": 13,
        "imageUrl": "https://i.imgur.com/mli9QVH.png",
        "title": "Double the innovation: parallel development on Polkadot and Kusama",
        "details": "Polkadot and Kusama operate in parallel, with new features and upgrades being tested on Kusama before actually being implemented on Polkadot. That way, developers like you ensure that new features are thoroughly tested and refined before they're released on the main network, providing a better experience for users."
      },
      {
        "id": 14,
        "imageUrl": "https://i.imgur.com/ZtKYg13.png",
        "title": "Their future together",
        "details": "Together, Polkadot and Kusama form a dynamic duo that encourages fearless exploration and experimentation. Picture your parachains as connections between the island blockchains, constantly growing and evolving, ready to connect with other blockchains and adapt to the ever-changing tides. This allows your parachains to continuously grow and change over time, evolving into something better. The only limit is how fast you can evolve!"
      },
      {
        "id": 15,
        "choices": [
          "Kusama is a Cosmos app-chain",
          "Kusama is a canary network for Polkadot",
          "Polkadot is a fork of Kusama/Dotsama"
        ],
        "correctChoice": "Kusama is a canary network for Polkadot",
        "title": "What is the relationship between Polkadot and Kusama/Dotsama?"
      },
      {
        "id": 16,
